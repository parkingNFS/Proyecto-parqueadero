"""
URL configuration for eicharking project.
...
name='hora_parking'),
    path('rol/', auth_views.rolView.as_view(template_name='templates/rol.html'),
name='rol'),
    path('vehiculo/', auth_views.vehiculoView.as_view(template_name='templates/vehiculo.html'),
name='vehiculo'),
